Feature: UUV Assistant vital features
 ...
 Scenario: Select with mouse type action
  ...
  And I should see a text box named "Generated UUV Script" and containing "Feature: Your amazing feature name Scenario: Action - Type Given I visit path \"http://127.0.0.1:3200/\" When I type the sentence \"Doe\" in the text box named \"Last name\""
